...
class EnglishRulesTest(unittest.TestCase):
    ...
    def test_get_governing_sibling_info_two_member_conjunction_phrase_and(self):
        self.compare_get_dependent_sibling_info('Richard and Christine went home', 2,
            '[]', 0, False)
    ...
    def test_independent_noun_nouns(self):
        self.compare_independent_noun('They went to look at the space suits',
            [7])

    def test_independent_noun_proper_nouns(self):
        self.compare_independent_noun('Peter and Jane went home',
            [0, 2])

    def test_independent_noun_numerals(self):
        self.compare_independent_noun('One of the two people saw two of the three people',
            [0, 4, 6, 10])

    def test_independent_noun_determiners(self):
        self.compare_independent_noun('Those of these people said that was interesting',
            [0, 3, 5])

    def test_independent_noun_pronouns(self):
        self.compare_independent_noun('Those of these people said somebody was interesting',
            [0, 3, 5])

    def test_independent_noun_blacklisted_phrase_beginning(self):
        self.compare_independent_noun('No wonder the issue was a problem',
            [3, 6])

    def test_independent_noun_blacklisted_phrase_end(self):
        self.compare_independent_noun('The issue was a problem, by the way',
            [1, 4])

    def test_independent_noun_blacklisted_phrase_middle_and_end(self):
        self.compare_independent_noun('The issue, for example, was a problem, by the way',
            [1, 8])
    ...
    def test_third_person_pronouns(self):
        self.compare_potential_anaphor('She went outside to look at her car',
            [0,6])
    ...
    def test_non_pleonastic_it_and_its(self):
        self.compare_potential_anaphor(
            'I saw a star. It was shining and its brilliance was amazing.',
            [5, 9])
    ...
    def compare_potential_pair(self, doc_text, referred_index, include_dependent_siblings,
        referring_index, expected_truth, *, excluded_nlps=[]):
    ...
    def test_potential_pair_trivial_plural(self):
        self.compare_potential_pair('I saw a man and a woman. They were walking', 3, True, 8, 2)

    def test_potential_pair_plurals_with_coordination_first(self):
        self.compare_potential_pair('I saw men and women. They were walking', 2, False, 6, 0)

    def test_potential_pair_plurals_with_coordination_second(self):
        self.compare_potential_pair('I saw men and women. They were walking', 4, False, 6, 0)
    ...
    def test_potential_pair_and_conjunction_referred_singular_referring(self):
        self.compare_potential_pair('I saw the man and the woman. He was there', 3, True, 8, 0)

    def test_potential_pair_and_conjunction_referred_singular_referring_control(self):
        self.compare_potential_pair('I saw the man and the woman. He was there', 3, False, 8, 2)
    ...
    def test_potential_pair_they_singular_antecedent_male_person(self):
        self.compare_potential_pair('I saw the gentleman. They were there', 3, False, 5, 1)
    ...
    def test_potential_pair_he_exclusively_female_name_compound_antecedent_control(self):
    ...
    def test_potential_pair_she_exclusively_male_antecedent(self):
        self.compare_potential_pair('I saw the gentleman. She was there', 3, False, 5, 0)
    ...
    def test_reflexive_in_wrong_situation_different_sentence(self):
        self.compare_potential_reflexive_pair('I saw the person. The other person saw himself',
            3, False, 9, 1, False, 1)

    def test_reflexive_in_wrong_situation_different_sentence_control(self):
        self.compare_potential_reflexive_pair('I saw the person. The other person saw him',
            3, False, 9, 2, False, 0)

    def test_reflexive_in_wrong_situation_same_sentence_1(self):
        self.compare_potential_reflexive_pair('I saw the person while the other person saw himself',
            3, False, 9, 1, False, 1)

    def test_reflexive_in_wrong_situation_same_sentence_control(self):
        self.compare_potential_reflexive_pair('I saw the person while the other person saw him',
            3, False, 9, 2, False, 0)

    def test_non_reflexive_in_wrong_situation_same_sentence(self):
        self.compare_potential_reflexive_pair('The man saw him',
            1, False, 3, 0, True, 0)

    def test_non_reflexive_in_wrong_situation_same_sentence_control(self):
        self.compare_potential_reflexive_pair('The man saw himself',
            1, False, 3, 2, True, 1)

    def test_non_reflexive_in_same_sentence_with_verb_conjunction(self):
        self.compare_potential_reflexive_pair('The man saw everything and heard himself',
            1, False, 6, 2, True, 1)

    def test_reflexive_in_right_situation_xcomp(self):
        self.compare_potential_reflexive_pair('The man wanted to see himself',
            1, False, 5, 2, True, 1)

    def test_reflexive_in_right_situation_pcomp(self):
        self.compare_potential_reflexive_pair('The man thought about seeing himself',
            1, False, 5, 2, True, 1)

    def test_reflexive_in_right_situation_within_subordinate_clause(self):
        self.compare_potential_reflexive_pair('He saw the man see himself',
            3, False, 5, 2, True, True, excluded_nlps=['core_web_sm'])

    def test_reflexive_in_right_situation_within_subordinate_clause_control(self):
        self.compare_potential_reflexive_pair('He saw the man see himself',
            0, False, 5, 1, False, True, excluded_nlps=['core_web_sm'])

    def test_reflexive_with_conjuction(self):
        self.compare_potential_reflexive_pair('The house and the car outdid themselves',
            1, True, 6, 2, True, 1)
    ...
    def test_reflexive_with_passive(self):
        self.compare_potential_reflexive_pair('The house was outdone by itself',
            1, False, 5, 2, True, 1)

    def test_reflexive_with_passive_and_conjunction(self):
        self.compare_potential_reflexive_pair('The house and the car were outdone by themselves',
            1, False, 8, 0, True, 1)

    def test_reflexive_with_object_antecedent(self):
        self.compare_potential_reflexive_pair('He mixed the chemical with itself',
            3, False, 5, 2, True, 1)
        self.compare_potential_reflexive_pair('He mixed the chemical with itself',
            0, False, 5, 0, True, 1)

    def test_reflexive_with_object_antecedent_and_coordination(self):
        self.compare_potential_reflexive_pair('He mixed the chemical and the salt with themselves',
            3, True, 8, 2, True, 1)
        self.compare_potential_reflexive_pair('He mixed the chemical and the salt with themselves',
            0, False, 8, 0, True, 1)

    def test_reflexive_with_verb_coordination_one_subject(self):
        self.compare_potential_reflexive_pair('He saw it and congratulated himself',
            0, False, 5, 2, True, 1)
    ...
    def test_reflexive_with_to(self):
        self.compare_potential_reflexive_pair(
            'They wanted the boy to know himself',
            3, False, 6, 2, True, 1)
    ...
    def test_reflexive_with_to_antecedent_within_noun_phrase(self):
        self.compare_potential_reflexive_pair(
            ...
            6, False, 9, 2, True, True, excluded_nlps=['core_web_sm', 'core_web_md', 'core_web_lg'])

    def test_non_reflexive_in_wrong_situation_subordinate_clause(self):
        self.compare_potential_reflexive_pair('Although he saw him, he was happy.',
            1, False, 3, 0, True, 0)

    def test_reflexive_completely_within_noun_phrase_1(self):
        self.compare_potential_reflexive_pair(
            "My friend's opinion of himself was exaggerated",
            1, False, 5, 2, True, 1)
    ...
    def test_reflexive_completely_within_noun_phrase_1_control(self):
        self.compare_potential_reflexive_pair(
            "My friend's opinion of him was exaggerated",
            1, False, 5, 0, True, 0)
    ...
    def test_reflexive_double_coordination_without_preposition(self):
        self.compare_potential_reflexive_pair('Peter and Jane saw him and her.',
            0, False, 4, 0, True, 0)
        self.compare_potential_reflexive_pair('Peter and Jane saw him and her.',
            2, False, 6, 0, True, 0)

    def test_reflexive_double_coordination_with_preposition(self):
        self.compare_potential_reflexive_pair('Peter and Jane spoke to him and her.',
            0, False, 5, 0, True, 0)
        self.compare_potential_reflexive_pair('Peter and Jane spoke to him and her.',
            2, False, 7, 0, True, 0)

    def test_reflexive_pronoun_precedes_referent(self):
        self.compare_potential_reflexive_pair('Peter saw himself and Peter came in.',
            4, False, 2, 1, False, 1)
    ...
    def test_cataphora_simple_case(self):
        self.compare_potential_cataphoric_pair('Although he was enjoying himself, Tom went home.',
            6, False, 1, True, excluded_nlps=['core_web_trf'])
    ...
    def test_cataphora_tokens_deeper_in_tree_1(self):
        self.compare_potential_cataphoric_pair(
            'Although all his fans talked about wanting to see him, the press had long since stopped bothering James.', 18, False, 2, True)

    def test_cataphora_tokens_deeper_in_tree_2(self):
        self.compare_potential_cataphoric_pair(
            'Although all his fans talked about wanting to see him, the press had long since stopped bothering James.', 18, False, 9, True)

    def test_cataphora_tokens_deeper_in_tree_conjunction_1(self):
        self.compare_potential_cataphoric_pair(
            'Although all their fans talked about wanting to see them, the press had long since stopped bothering James and Jane.', 18, True, 2, True)

    def test_cataphora_tokens_deeper_in_tree_conjunction_2(self):
        self.compare_potential_cataphoric_pair(
            'Although all their fans talked about wanting to see them, the press had long since stopped bothering James and Jane.', 18, True, 9, True)

    def test_cataphora_tokens_deeper_in_tree_conjunction_control(self):
        self.compare_potential_cataphoric_pair(
            'Although all their fans talked about wanting to see them, the press had long since stopped bothering James and Jane.', 18, False, 9, False)

    def test_cataphora_wrong_structure_1(self):
        self.compare_potential_cataphoric_pair(
            'The press had long since interviewed him although all his fans talked about wanting to see James', 16, False, 6, False)
    ...
    def test_cataphora_wrong_structure_conjunction(self):
        self.compare_potential_cataphoric_pair(
            'The press had long since interviewed them although all their fans talked about wanting to see James and Jane', 16, True, 6, False)

    def test_cataphora_conjunction_at_verb_level(self):
        self.compare_potential_cataphoric_pair(
            'Although he was available, Peter had time and John came home', 9, False, 1, False)
    ...
    def test_potential_referreds_last_token(self):
        self.compare_potential_referreds('Richard came in and someone saw him', 6,
            ['Richard(0)'])
    ...
    def test_potential_referreds_cataphora_conjunction(self):
        self.compare_potential_referreds(
            'Although they came in, someone saw Peter and Jane', 1,
    ...
    def test_potentially_indefinite_common_noun_conjunction_first_member_control(self):
        self.compare_potentially_indefinite('I spoke to the man and the woman', 4, False)
