...
class GermanRulesTest(unittest.TestCase):
    ...
    def test_get_dependent_sibling_info_no_conjunction(self):
        self.compare_get_dependent_sibling_info('Richard ging heim', 0, '[]', None, False)

    def test_get_dependent_sibling_info_two_member_conjunction_phrase_and(self):
        self.compare_get_dependent_sibling_info('Richard und Christine gingen heim', 0,
    ...
    def test_get_dependent_sibling_info_three_member_conjunction_phrase_with_comma_and(self):
        self.compare_get_dependent_sibling_info('Carol, Richard und Ralf hatten ein Meeting', 0,
            '[Richard, Ralf]', None, False)

    def test_get_dependent_sibling_info_three_member_conjunction_phrase_with_comma_or(self):
        self.compare_get_dependent_sibling_info('Carol, Richard oder Ralf hatte ein Meeting', 0,
    ...
    def test_independent_noun_simple(self):
        self.compare_independent_noun('Sie haben sich die großen Löwen angeschaut',
            [5])
    ...
    def test_substituting_indefinite_pronoun(self):
        self.compare_independent_noun(
            'Einer der Jungen ist heimgekommen',
            [0, 2])
    ...
    def test_blacklisted(self):
        self.compare_independent_noun(
            'Meines Erachtens ist der Junge zum Beispiel immer müde',
            [4])

    def test_blacklisted_control(self):
        self.compare_independent_noun(
            'Meines Erachtens ist das ein gutes Beispiel.',
            [6])

    def test_proper_noun_component(self):
        self.compare_independent_noun(
            'Sie fuhren in die Walt Disney World.',
            [6])
    ...
    def test_third_person_pronouns(self):
        self.compare_potential_anaphor('Sie ist rausgegangen, um ihr Auto anzusehen',
            [0,5])

    def test_first_and_second_person_pronouns(self):
        self.compare_potential_anaphor('Ich weiß, dass du ihn kennst',
            [5])
    ...
    def test_formal_pronouns(self):
        self.compare_potential_anaphor('Diese ist rausgegangen, um jenen zu treffen. Diese Frau war da aus jenem Grund.',
            [0,5])

    def test_prepositions_1(self):
        self.compare_potential_anaphor('Sie aß es damit.',
            [0,2,3])

    def test_prepositions_2(self):
        self.compare_potential_anaphor('Und damit aß sie es.',
            [1,3,4])
    ...
    def test_prepositions_control_2(self):
        self.compare_potential_anaphor('Sie aß es daher.',
            [0,2])

    def test_prepositions_control_with_verb_phrase(self):
        self.compare_potential_anaphor('Sie aß es damit, dass sie ein Messer benutzte.',
            [0,2,6])

    def test_initial_prepositions(self):
        self.compare_potential_anaphor('Damit hast du es geschafft.',
            [3])

    def test_pleonastic_es(self):
        self.compare_potential_anaphor('Es scheint nicht sehr wahrscheinlich, dass er es weiß.',
            [7,8])
    ...
    def test_potentially_indefinite_common_noun_conjunction_first_member(self):
        self.compare_potentially_indefinite('Ich sprach mit einem Mann und einer Frau', 4, True)

    def test_potentially_indefinite_common_noun_conjunction_second_member(self):
        self.compare_potentially_indefinite('Ich sprach mit einem Mann und einer Frau', 7, True)

    def test_potentially_indefinite_common_noun_conjunction_first_member_control(self):
        self.compare_potentially_indefinite('Ich sprach mit dem Mann und der Frau', 4, False)
    ...
    def test_potentially_definite_common_noun_conjunction_first_member(self):
        self.compare_potentially_definite('Ich sprach mit diesem Mann und einer Frau', 4, True)

    def test_potentially_definite_common_noun_conjunction_second_member(self):
        self.compare_potentially_definite('Ich sprach mit einem Mann und jener Frau', 7, True)

    def test_potentially_definite_common_noun_conjunction_first_member_control(self):
        self.compare_potentially_definite('Ich sprach mit dem Mann und einer Frau', 7, False)
    ...
    def test_potential_pair_trivial_masc_control_2(self):
        self.compare_potential_pair('Ich sah einen Mann. Dann lief es und weinte', 3, False, 7, 0)
    ...
    def test_potential_pair_trivial_masc_possessive(self):
        self.compare_potential_pair('Ich sah einen Mann. Sein Hund lief', 3, False, 5, 2)
    ...
    def test_potential_pair_trivial_plur_single_element(self):
        self.compare_potential_pair('Ich sah einige Frauen. Sie standen', 3, False, 5, 2)
    ...
    def test_potential_pair_trivial_plur_single_element_control_3(self):
        self.compare_potential_pair('Ich sah einige Frauen. Dieses stand', 3, False, 5, 0)

    def test_potential_pair_trivial_plur_single_element_possessive(self):
        self.compare_potential_pair('Ich sah einige Frauen. Ihr Hund stand', 3, False, 5, 2)

    def test_potential_pair_trivial_plur_single_element_possessive_control(self):
        self.compare_potential_pair('Ich sah einige Frauen. Sein Hund stand', 3, False, 5, 0)

    def test_potential_pair_trivial_plur_coordination(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sie standen', 3, True, 8, 2)

    def test_potential_pair_trivial_plur_coordination_control_1(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Er stand', 3, True, 8, 0)

    def test_potential_pair_trivial_plur_coordination_control_2(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sie stand', 3, True, 8, 0)

    def test_potential_pair_trivial_plur_coordination_control_3(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Dieses stand', 3, True, 8, 0)

    def test_potential_pair_trivial_plur_coordination_possessive(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Ihr Hund stand', 3, True, 8, 2)
    def test_potential_pair_trivial_plur_coordination_possessive_control(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sein Hund stand', 3, True, 8, 0)

    def test_potential_pair_trivial_plur_coordination_elements_plural_1(self):
        self.compare_potential_pair('Ich sah einige Männer und einige Frauen. Sie standen',
            3, False, 8, 0)
    ...
    def test_potential_pair_trivial_sing_coordination_first_element(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Er stand', 3, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_first_element_control_1(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sie stand', 3, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_first_element_control_2(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Dieses stand', 3, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_first_element_control_3(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sie standen', 3, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_first_element_possessive(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sein Hund stand', 3, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_first_element_possessive_control(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Ihr Hund stand', 3, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_second_element(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sie stand', 6, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_second_element_control_1(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Er stand', 6, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_second_element_control_2(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Dieses stand', 6, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_second_element_control_3(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sie standen', 6, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_second_element_possessive(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Ihr Hund stand', 6, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_second_element_possessive(self):
        self.compare_potential_pair('Ich sah einen Mann und eine Frau. Sein Hund stand', 6, False, 8, 0)
    ...
    def test_potential_pair_male_neut_2(self):
        self.compare_potential_pair('Ich sah ein Mannsbild. Dieses stand', 3, False, 5, 2)
    ...
    def test_potential_pair_male_neut_control_2(self):
        self.compare_potential_pair('Ich sah ein Mannsbild. Sie standen', 3, False, 5, 0)
    ...
    def test_potential_pair_diminutive_1(self):
        self.compare_potential_pair('Ich sah ein Äuglein. Er stand', 3, False, 5, 2)

    def test_potential_pair_diminutive_2(self):
        self.compare_potential_pair('Ich sah ein Äuglein. Sie stand', 3, False, 5, 2)

    def test_potential_pair_diminutive_3(self):
        self.compare_potential_pair('Ich sah ein Äuglein. Dieses stand', 3, False, 5, 2)

    def test_potential_pair_diminutive_control(self):
        self.compare_potential_pair('Ich sah ein Äuglein. Sie standen', 3, False, 5, 0)
    ...
    def test_potential_pair_female_name_control_2(self):
        self.compare_potential_pair('Ich sah Jana. Dieses stand', 2, False, 4, 0,
    ...
    def test_potential_pair_masc_dative_anaphor_1(self):
        self.compare_potential_pair('Ich sah einen Mann. Mit ihm ging ich in die Stadt',
            3, False, 6, 2)

    def test_potential_pair_masc_dative_anaphor_2(self):
        self.compare_potential_pair('Ich sah ein Kind. Mit ihm ging ich in die Stadt',
            3, False, 6, 2)

    def test_potential_pair_masc_dative_anaphor_control_1(self):
        self.compare_potential_pair('Ich sah eine Frau. Mit ihm ging ich in die Stadt',
            3, False, 6, 0)

    def test_potential_pair_masc_dative_anaphor_control_2(self):
        self.compare_potential_pair('Ich sah einige Frauen. Mit ihm ging ich in die Stadt',
            3, False, 6, 0)

    def test_potential_pair_fem_acc_anaphor_1(self):
        self.compare_potential_pair('Ich sah eine Frau. Ich sah sie', 3, False, 7, 2,
            excluded_nlps=['core_news_sm'])

    def test_potential_pair_fem_acc_anaphor_2(self):
        self.compare_potential_pair('Ich sah einige Frauen. Ich sah sie', 3, False, 7, 2,
            excluded_nlps=['core_news_sm'])
    ...
    def test_potential_pair_proav_1(self):
        self.compare_potential_pair('Sie nahm einen Löffel und aß damit', 3, False, 6, 2)
    ...
    def test_potential_pair_proav_4(self):
        self.compare_potential_pair('Sie nahm einige Messer und aß damit', 3, False, 6, 2)

    def test_potential_pair_proav_srd_1(self):
        self.compare_potential_pair('Sie nahm einige Messer. Sie aß damit', 3, False, 7, 2)

    def test_potential_pair_proav_srd_2(self):
        self.compare_potential_pair('Sie nahm einige Messer. Dann passierte etwas. Sie aß damit',
            3, False, 11, 0)

    def test_potential_pair_proav_male_anaphor(self):
        self.compare_potential_pair('Er nahm einige Messer und aß damit',
            0, False, 6, 0)

    def test_potential_pair_proav_female_anaphor(self):
        self.compare_potential_pair('Sie nahm einige Messer und aß damit',
            0, False, 6, 0)

    def test_potential_pair_proav_male_name(self):
        self.compare_potential_pair('Richard nahm einen Löffel und aß damit', 0, False, 6, 0)

    def test_potential_pair_proav_female_name(self):
        self.compare_potential_pair('Jana nahm einen Löffel und aß damit', 0, False, 6, 0)

    def test_potential_pair_proav_person(self):
        self.compare_potential_pair('Ploztrok nahm einen Löffel und aß damit', 0, False, 6, 0)

    def test_potential_pair_proav_place(self):
        self.compare_potential_pair('München ist schön und verdient Geld damit', 0, False, 6, 0)

    def test_potential_pair_proav_company(self):
        self.compare_potential_pair('BMW nahm einen Löffel und aß damit', 0, False, 6, 0)
    ...
    def test_potential_pair_possessive_in_genitive_phrase_simple_not_directly(self):
        self.compare_potential_pair('Der Mann seines Freundes', 1, False, 2, 2, directly=False)

    def test_potential_pair_possessive_in_genitive_phrase_coordination_head(self):
        self.compare_potential_pair('Der Mann und der Mann seines Freundes', 1, False, 5, 2,
            excluded_nlps=['core_news_sm'])

    def test_potential_pair_possessive_in_genitive_phrase_coordination_child(self):
        self.compare_potential_pair('Der Mann und der Mann seines Freundes und seines Freundes',
            4, False, 8, 0, excluded_nlps='core_news_sm')
    ...
    def test_potential_pair_possessive_in_genitive_phrase_double_simple(self):
        self.compare_potential_pair('Der Mann seines Freundes seines Freundes', 1, False, 4, 0)

    def test_potential_pair_possessive_in_genitive_phrase_double_control_1(self):
        self.compare_potential_pair('Der Mann mit dem Freund seines Freundes', 1, False, 5, 2)

    def test_potential_pair_possessive_in_genitive_phrase_double_control_1(self):
        self.compare_potential_pair('Der Mann des Freundes mit seinem Freund', 1, False, 5, 2)

    def test_potential_pair_possessive_in_genitive_phrase_double_coordination_everywhere_1(self):
        self.compare_potential_pair('Der Mann und der Mann seines Freundes und seines Freundes seines Freundes und seines Freundes', 1, False, 13, 2)

    def test_potential_pair_possessive_in_genitive_phrase_double_coordination_everywhere_2(self):
        self.compare_potential_pair('Der Mann und der Mann seines Freundes und seines Freundes seines Freundes und seines Freundes', 4, False, 13, 0)

    def test_potential_pair_neuter_subject_personal_verb(self):
        self.compare_potential_pair('Das Haus war da. Es sagte, alles OK.', 1, False, 5, 1)

    def test_potential_pair_neuter_subject_personal_verb_control_conjunction(self):
        self.compare_potential_pair('Das Haus und das Haus waren da. Sie sagten, alles OK.', 1, True, 8, 1)
    ...
    def test_potential_pair_neuter_subject_personal_verb_control_3(self):
        self.compare_potential_pair('Der Mann kam hinein. Er sagte, alles OK.', 1, False, 5, 1)

    def test_potential_pair_neuter_subject_personal_verb_control_conjunction_1(self):
        self.compare_potential_pair('Peter und das Haus waren da. Sie sagten, alles OK.', 0, True, 7, 2)
    ...
    def test_reflexive_in_wrong_situation_different_sentence(self):
        self.compare_potential_reflexive_pair('Ich sah den Menschen. Der Mensch sah sich',
            3, False, 8, 0, False, 2)

    def test_reflexive_in_wrong_situation_different_sentence_control(self):
        self.compare_potential_reflexive_pair('Ich sah den Menschen. Der andere Mensch sah ihn',
            3, False, 9, 2, False, 0)

    def test_reflexive_in_wrong_situation_same_sentence_1(self):
        self.compare_potential_reflexive_pair('Ich sah den Menschen, während der andere Mensch sich selbst sah.',
            3, False, 9, 0, False, 2)
    ...
    def test_non_reflexive_in_wrong_situation_same_sentence(self):
        self.compare_potential_reflexive_pair('Der Mann sah ihn.',
            1, False, 3, 0, True, 0)

    def test_non_reflexive_in_wrong_situation_same_sentence_control(self):
        self.compare_potential_reflexive_pair('Der Mann sah sich.',
            1, False, 3, 2, True, 2)

    def test_non_reflexive_in_same_sentence_with_verb_conjunction(self):
        self.compare_potential_reflexive_pair('Der Mann hörte alles und sah sich.',
            1, False, 6, 2, True, 2)

    def test_reflexive_in_right_situation_modal(self):
        self.compare_potential_reflexive_pair('Der Mann wollte sich sehen.',
            1, False, 3, 2, True, 2)

    def test_reflexive_in_right_situation_zu_clause(self):
        self.compare_potential_reflexive_pair('Der Mann dachte darüber nach, sich zu sehen.',
            1, False, 6, 2, True, 2)

    def test_reflexive_in_right_situation_within_subordinate_clause(self):
        self.compare_potential_reflexive_pair('Er wusste, dass der Mann sich selbst sah.',
            5, False, 6, 2, True, 2)
    ...
    def test_reflexive_in_right_situation_within_subordinate_clause_anaphor_first(self):
        self.compare_potential_reflexive_pair('Er wusste, dass sich der Mann selbst sah.',
            6, False, 4, 2, True, 2)
    ...
    def test_reflexive_with_conjuction(self):
        self.compare_potential_reflexive_pair('Das Haus und das Auto haben sich selbst übertroffen',
            1, True, 6, 2, True, 2)
    ...
    def test_reflexive_with_passive(self):
        self.compare_potential_reflexive_pair('Das Haus wurde durch sich selbst übertroffen',
            1, False, 4, 2, True, 2)

    def test_reflexive_with_passive_and_conjunction(self):
        self.compare_potential_reflexive_pair('Das Haus und das Auto wurden durch sich selbst übertroffen',
            1, True, 7, 2, True, 2)

    def test_reflexive_with_object_antecedent(self):
        self.compare_potential_reflexive_pair('Er mischte die Chemikalie mit sich.',
            3, False, 5, 2, True, 2)
        self.compare_potential_reflexive_pair('Er mischte die Chemikalie mit sich.',
            0, False, 5, 2, True, 2)

    def test_reflexive_with_object_antecedent_and_coordination(self):
        self.compare_potential_reflexive_pair('Er mischte die Chemikalie und das Salz mit sich.',
            3, True, 8, 2, True, 2)
        self.compare_potential_reflexive_pair('Er mischte die Chemikalie und das Salz mit sich.',
            0, False, 8, 2, True, 2)

    def test_reflexive_with_verb_coordination_one_subject(self):
        self.compare_potential_reflexive_pair('Er sah es und gratulierte sich.',
            0, False, 5, 2, True, 2)
    ...
    def test_non_reflexive_in_wrong_situation_subordinate_clause(self):
        self.compare_potential_reflexive_pair('Obwohl er ihn sah, war er glücklich.',
            1, False, 2, 0, True, 0)
    ...
    def test_reflexive_double_coordination_without_preposition(self):
        self.compare_potential_reflexive_pair('Wolfgang und Marie sahen ihn und sie.',
            0, False, 4, 0, True, 0)
        self.compare_potential_reflexive_pair('Wolfgang und Marie sahen ihn und sie.',
            2, False, 6, 0, True, False, excluded_nlps=['core_news_lg'])
    ...
    def test_potential_noun_pair_proper_noun_test(self):
        self.compare_potential_noun_pair('von Bach über Beethoven, Brahms, Brückner.',
            5, 7, False)
